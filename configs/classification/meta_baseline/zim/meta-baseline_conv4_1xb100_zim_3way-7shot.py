...
num_ways = 3 # classes in support set
num_shots = 7 # samples per each class in support set
num_queries = 3 # how many queries are to be made
...
optimizer = dict(
    type='SGD',
    lr=0.1, # TODO: lr=0.05; weight_decay=0.0001
    momentum=0.9,
    weight_decay=0.0001)
...
lr_config = dict(
    ...
    warmup_iters=3000,
    warmup_ratio=0.25,
    step=[4000, 20000, 40000, 60000]) # steps to decay the learning rate
